...
loc_E0:
		...
		dc.b "NAYFRESH2026    " ; Copyright holder and release date (generally year)	
...
; End of function WaitForVBla
		...
		include "Gamemodes/Scene - Sega Screen.asm"
        include "Gamemodes/Scene - Title Screen.asm"
; ===========================================================================
; ---------------------------------------------------------------------------
...
; ===========================================================================
        ...
        include "Gamemodes/Scene - Demo.asm"
...
; ===========================================================================
		...
		include "Gamemodes/Scene - Special Stage.asm"
...
Map_ESth:	include	"_maps/Ending Sequence STH.asm"
        ...
        include "Gamemodes/Scene - Credits.asm"
