...
dFPCSnare4FLStudio =     SMPS_id(ptr_dacE2)
dThe707CrashFLStudio =     SMPS_id(ptr_dacE3)
dFirestarter =     SMPS_id(ptr_dacE4)

; -------- PWM SAMPLES KNUCKLES CHATOIX ----------

pwmElectricKick =		SMPS_id(ptr_dacE5)
pwmElectricSnare =		SMPS_id(ptr_dacE6)
pwmSplashCymbal =		SMPS_id(ptr_dacE7)
pwmRideBell =			SMPS_id(ptr_dacE8)
pwmHighTom =			SMPS_id(ptr_dacE9)
pwmMidTom =			SMPS_id(ptr_dacEA)
pwmLowTom =			SMPS_id(ptr_dacEB)
pwmElectricHiHat =		SMPS_id(ptr_dacEC)
pwmCrashCymbal =		SMPS_id(ptr_dacED)
pwmClap =			SMPS_id(ptr_dacEE)
pwmAcousticKick =		SMPS_id(ptr_dacEF)
pwmAcousticSnare =		SMPS_id(ptr_dacF0)
pwmBell =			SMPS_id(ptr_dacF1)
pwmFingersSnapping =		SMPS_id(ptr_dacF2)
pwmCowbell =			SMPS_id(ptr_dacF3)
pwmHighClick =			SMPS_id(ptr_dacF4)
pwmLowClick =			SMPS_id(ptr_dacF5)
pwmHighBongo =			SMPS_id(ptr_dacF6)
pwmLowBongo =			SMPS_id(ptr_dacF7)
pwmHighTimpani =		SMPS_id(ptr_dacF8)
pwmLowTimpani =			SMPS_id(ptr_dacF9)
pwmSilence =			SMPS_id(ptr_dacFA)

; ------ END OF PWM SAMPLES KNUCKLES CHATOIX -----
