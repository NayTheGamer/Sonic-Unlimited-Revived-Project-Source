...
.play_sample:
	...
	jr	zChangeBankswitch
		...
		ld	a,(zYM2612_D0)			; 13	; load buffer to write to
		cpl					; 04	; change buffer
		ld	(zYM2612_D0),a			; 13	; update...	
...
BreakDMA:
		...
		jp	m,BDMA_ReadSet			; 10	; if so, then it's pointing to the window, and is the read set
			cp	zSample1Pointer>>008h		; 07	; is the buffer address exchanged with de? (i.e. is hl at volume instead of buffer)
