...
;		move.w	d0,(v_bgscrposy_dup).w
	...
	.cloudLoop32:		; lower cloud (16px)
		...
		neg.w	d0
	.mountainLoop2:		; distant mountains (48px)
		move.l	d0,(a1)+
		dbf	d1,.mountainLoop2

		move.w	#$27,d1
		move.w	(v_bg2screenposx).w,d0
		neg.w	d0
	.hillLoop2:			; hills & waterfalls (40px)
		move.l	d0,(a1)+
		dbf	d1,.hillLoop2
...
Menu_Level_Select_Text: 
                dc.b    $0E, _F, _A, _N, _A, _T, _I, _C, __, _S, _U, _N, _S, _E, _T, __
                dc.b    $0E, _C, _R, _U, _M, _B, _L, _E, _D, __, _M, _A, _R, _B, _L, _E
                dc.b    $0E, _S, _P, _A, _R, _K, _L, _I, _N, _G, __, _C, _I, _T, _Y, __
                dc.b    $0E, _L, _A, _B, _Y, _R, _I, _N, _T, _H, __, _D, _E, _C, _A, _Y
                dc.b    $0E, _P, _E, _A, _C, _E, _F, _U, _L, __, _C, _I, _T, _Y, __, __
                dc.b    $0E, _S, _C, _R, _A, _P, __, _B, _R, _A, _I, _N, __, __, __, __
                dc.b    $0E, _F, _I, _N, _A, _L, __, _B, _O, _S, _S, _F, _I, _G, _H, _T                                    
