...
BusError:
	__ErrorMessage "BUS ERROR                             PLEASE ADDRESS THIS TO THE CREATOR ON SSRG NAYLEN DEVELOPER", _eh_default|_eh_address_error	

AddressError:
	__ErrorMessage "ADDRESS ERROR                         PLEASE ADDRESS THIS TO THE CREATOR ON SSRG NAYLEN DEVELOPER", _eh_default|_eh_address_error	

IllegalInstr:
	__ErrorMessage "ILLEGAL INSTRUCTION                   PLEASE ADDRESS THIS TO THE CREATOR ON SSRG NAYLEN DEVELOPER", _eh_default

ZeroDivide:
	__ErrorMessage "ZERO DIVIDE                           PLEASE ADDRESS THIS TO THE CREATOR ON SSRG NAYLEN DEVELOPER", _eh_default

ChkInstr:
	__ErrorMessage "CHK INSTRUCTION                       PLEASE ADDRESS THIS TO THE CREATOR ON SSRG NAYLEN DEVELOPER", _eh_default

TrapvInstr:
	__ErrorMessage "TRAPV INSTRUCTION                     PLEASE ADDRESS THIS TO THE CREATOR ON SSRG NAYLEN DEVELOPER", _eh_default

PrivilegeViol:
	__ErrorMessage "PRIVILEGE VIOLATION                   PLEASE ADDRESS THIS TO THE CREATOR ON SSRG NAYLEN DEVELOPER", _eh_default

Trace:
	__ErrorMessage "TRACE                                 PLEASE ADDRESS THIS TO THE CREATOR ON SSRG NAYLEN DEVELOPER", _eh_default

Line1010Emu:
	__ErrorMessage "LINE 1010 EMULATOR                    PLEASE ADDRESS THIS TO THE CREATOR ON SSRG NAYLEN DEVELOPER", _eh_default

Line1111Emu:
	__ErrorMessage "LINE 1111 EMULATOR                    PLEASE ADDRESS THIS TO THE CREATOR ON SSRG NAYLEN DEVELOPER", _eh_default

ErrorExcept:
	__ErrorMessage "ERROR EXCEPTION                       PLEASE ADDRESS THIS TO THE CREATOR ON SSRG NAYLEN DEVELOPER", _eh_default
