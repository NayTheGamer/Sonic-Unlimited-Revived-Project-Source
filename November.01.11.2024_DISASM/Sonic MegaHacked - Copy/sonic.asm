...
ZoneCount	  = 6	; discrete zones are: GHZ, MZ, SYZ, LZ, SLZ, and SBZ, Hub world
...
;		dc.b "(C)SEGA 1991.APR" ; Copyright holder and release date (generally year)
		dc.b "NAYFRESH2025.JAN" ; Copyright holder and release date (generally year)	
...
;ptr_GM_Custom1:	bra.w	GM_Custom1		; Custom1 Screen ($40)
...
Tit_ClrObj2:
	...
	;	move.b	#id_PSBTM,(v_objspace+$E0).w ; load "TM" object
...
;		move.b	#5,$FFFFD1C0.w	
        move.b    #5,$FFFFD1C0.w	
		bne.s	 Sonic_Control				;  If not, branch
...
Nem_Custom1:	binclude	"Custom1/Tiles.bin" ; large Sega logo
			even
Asm_Eni_Custom1:	include	"Custom1/mappings.bin" ; large Sega logo (mappings)
			even		
