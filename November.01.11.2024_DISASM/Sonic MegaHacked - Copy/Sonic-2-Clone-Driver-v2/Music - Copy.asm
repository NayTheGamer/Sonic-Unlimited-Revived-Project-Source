...
ptr_mus05:	SMPS_MUSIC_METADATA	Music05, s1TempotoS3($02)-$5, 0	; SYZ
...
ptr_mus14:	SMPS_MUSIC_METADATA	Music14, s1TempotoS3($33), 0	; Level Select
ptr_mus15:	SMPS_MUSIC_METADATA	Music15, s1TempotoS3($06), 0	; SpeedShoes
ptr_mus16:	SMPS_MUSIC_METADATA	Music16, s1TempotoS3($FF), 0	; HPZ
ptr_mus17:	SMPS_MUSIC_METADATA	Music17, s1TempotoS3($FF), 0	; SegaJingle
ptr_mus18:	SMPS_MUSIC_METADATA	Music18, s1TempotoS3($FF), 0	; Test1
ptr_musend
...
Music14:	include		"Sonic-2-Clone-Driver-v2/music/Mus94 - LevelSelect.asm"
		even
Music15:	include		"Sonic-2-Clone-Driver-v2/music/Mus95 - SpeedShoes.asm"
		even		
Music16:	include		"Sonic-2-Clone-Driver-v2/music/Mus96 - HPZ.asm"
		even
Music17:	include		"Sonic-2-Clone-Driver-v2/music/Mus97 - SegaJingle.asm"
		even						
Music18:	include		"Sonic-2-Clone-Driver-v2/music/Mus98 - Test1.asm"
		even								
