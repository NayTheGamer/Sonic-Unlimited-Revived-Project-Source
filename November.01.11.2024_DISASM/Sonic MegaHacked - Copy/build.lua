...
-- Delete old ROM.
os.remove("s1unlimitedbuilt.prev.bin")

-- Backup the most recent ROM.
os.rename("s1unlimitedbuilt.bin", "s1unlimitedbuilt.prev.bin")

-- Assemble the ROM.
local assemble_result = common.assemble_file("sonic.asm", "s1unlimitedbuilt.bin", tools.as, "", tools.s1p2bin, improved_dac_driver_compression and "" or " -a", false)
