...
bgm_LevelSelect =		SMPS_id(ptr_mus14)
bgm_Options =		SMPS_id(ptr_mus15)
;bgm_ExtraLifeYes =		SMPS_id(ptr_mus15)
;bgm_HPZ =		SMPS_id(ptr_mus16)
;bgm_SegaJingle =		SMPS_id(ptr_mus17)
;bgm_GotThroughCardGunstarHeros = SMPS_id(ptr_mus18)
;bgm_Test1 =		SMPS_id(ptr_mus18)
;bgm_COI1 =		SMPS_id(ptr_mus19)
;bgm_COI2 =		SMPS_id(ptr_mus1A)
;bgm_COI3 =		SMPS_id(ptr_mus1B)
...
SndID_SpindashRev =		SMPS_id(ptr_sndD1)
sfx_SpindashRelease =		SMPS_id(ptr_sndD2)
sfx_DropDash =		SMPS_id(ptr_sndD3)
sfx_TransitionLmao =		SMPS_id(ptr_sndD4)
