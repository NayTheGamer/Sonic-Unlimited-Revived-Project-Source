...
_linear3 = $0400
   ...
   ;        Mode           Speed/dist       Number of lines	   
   dc.w   _moving3,       $0030,           10                ; Stars (6 layers)
   dc.w   _moving3|$0,       $0040,           10                ; Stars (6 layers)
   dc.w   _moving3|$0,       $0041,           10                ; Stars (6 layers)   
   dc.w   _moving3|$1,       $0042,           10                ; Stars (6 layers)   
   dc.w   _moving3|$1,       $0043,           10                ; Stars (6 layers)   
   dc.w   _moving3|$2,       $0044,           10                ; Stars (6 layers)   
   dc.w   _moving3|$2,       $0045,           10                ; Stars (6 layers)   
   dc.w   _moving3|$1,       $0046,           10                ; Stars (6 layers)   
   dc.w   _moving3|$1,       $0047,           10                ; Stars (6 layers)   
   dc.w   _moving3|$1,       $0048,           10                ; Stars (6 layers)   
   dc.w   _moving3|$1,       $0049,           10                ; Stars (6 layers)      
   dc.w   _moving3|$2,       $0050,           30                ; Stars (6 layers)     
