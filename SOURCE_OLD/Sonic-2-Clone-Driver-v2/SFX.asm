...
SoundCF:	include	"Sonic-2-Clone-Driver-v2/SFX/SndCF - Signpost.asm"
		even
SoundD1:	include	"Sonic-2-Clone-Driver-v2/SFX/SndD1 - Spindash.asm"
		even		
SoundD2:	include	"Sonic-2-Clone-Driver-v2/SFX/SndD2 - SpindashRelease.asm"
		even	
SoundD3:	include	"Sonic-2-Clone-Driver-v2/SFX/SndD3 - Drop Dash.asm"
		even	
SoundD4:	include	"Sonic-2-Clone-Driver-v2/SFX/DF - Super Transform.asm"
		even				