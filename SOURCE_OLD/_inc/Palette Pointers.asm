...
ptr_Pal_SegaBG:		palp	Pal_SegaBG,v_pal_dry,$20		; 0 - Sega logo
...
;ptr_Pal_HPZ:		palp	Pal_HPZ,v_pal_dry+$20, $30		; 4 - GHZ
...
ptr_Pal_Ending:		palp	Pal_Ending,v_pal_dry+$20, $30		; $13 (19) - ending sequence
ptr_Pal_Menu:        palp    Pal_Menu,v_pal_dry,$40        ; $14 (20) - Sonic 2 level select
ptr_Pal_SRetro:		palp	Pal_SRetro,v_pal_dry,$20		; 0 - Sega logo
ptr_Pal_Options:		palp	Pal_Options,v_pal_dry,$20		; 0 - Sega logo
			even
...
;palid_HPZ:		equ (ptr_Pal_HPZ-PalPointers)/8
...
palid_SRetro:		equ (ptr_Pal_SRetro-PalPointers)/8
