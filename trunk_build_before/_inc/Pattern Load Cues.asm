...
ptr_PLC_TitleCard_OG:	dc.w PLC_TitleCard_OG-ArtLoadCues
...
;		plcm	Nem_Points, $D800	; points from enemy
PLC_Mainend:
; ---------------------------------------------------------------------------
...
PLC_GHZ:	dc.w ((PLC_GHZ2-PLC_GHZ-2)/6)-1
	;	plcm	Kos_GHZ, 0		; GHZ main patterns
...
PLC_LZ:		dc.w ((PLC_LZ2-PLC_LZ-2)/6)-1
	;	plcm	Kos_LZ,0		; LZ main patterns
		plcm	Nem_LzBlock1, $6000	; block
		plcm	Nem_LzBlock2, $4000	; blocks
...
PLC_MZ:		dc.w ((PLC_MZ2-PLC_MZ-2)/6)-1
	;	plcm	Kos_MZ,0		; MZ main patterns
...
PLC_SLZ:	dc.w ((PLC_SLZ2-PLC_SLZ-2)/6)-1
	;	plcm	Kos_SLZ,0		; SLZ main patterns
...
PLC_SYZ:	dc.w ((PLC_SYZ2-PLC_SYZ-2)/6)-1
	;	plcm	Kos_SYZ,0		; SYZ main patterns
		plcm	Nem_Crabmeat, $8000	; crabmeat enemy
		plcm	Nem_Buzz, $8880		; buzz bomber enemy
		plcm	Nem_Yadrin, $8F60	; yadrin enemy
...
PLC_SBZ:	dc.w ((PLC_SBZ2-PLC_SBZ-2)/6)-1
	;	plcm	Kos_SBZ,0		; SBZ main patterns
...
PLC_TitleCard_OG:	dc.w ((PLC_TitleCardend_OG-PLC_TitleCard_OG-2)/6)-1
		plcm	Nem_TitleCard_OG, $B000
PLC_TitleCardend_OG:
; ---------------------------------------------------------------------------
...
PLC_Ending:	dc.w ((PLC_Endingend-PLC_Ending-2)/6)-1
	;	plcm	Kos_GHZ,0		; GHZ main patterns
;		plcm	Nem_GHZ_2nd,$39A0		; GHZ main patterns		
		plcm	Nem_Stalk, $6B00	; flower stalk
...
plcid_HPZ:		equ (ptr_PLC_GHZ-ArtLoadCues)/2		; 4
plcid_HPZ2:		equ (ptr_PLC_GHZ2-ArtLoadCues)/2	; 5
