...
;	dc.b	(pStart&$FF8000)/$68000		; Z80->68k bank index (TODO - tweak this to allow access to the 32X address range?)
    endm
...
;ptr_dacE2:	DACMetadata	23784, SCDLevelClear		; $E1	- SCDLevelClear
...
ptr_dacE1:	DACMetadata	19000, SnareDrum		; $82	- SnareDrum
	endif
...
ptr_dac91:	DACMetadata	 9806, Bongo		; $91	- Low-Bongo
	...
	if SMPS_S3DACSamples||SMPS_SKDACSamples||SMPS_S3DDACSamples
		; Sonic 3 & K & 3D
ptr_dac92:	DACMetadata	16000, SnareS3		; $92	- Snare (S3)
;ptr_dac92:	DACMetadata	23784, SnareS3		; $92	- Snare (S3)
...
ptr_dacE2:	DACMetadata	16000, FPCSnare4FLStudio	
ptr_dacE3:	DACMetadata	16000, The707CrashFLStudio
ptr_dacE4:	DACMetadata	16000, Firestarter			

ptr_dacE5:	DACMetadata 11050,	PWM_00 ;$00000000, $00000800
ptr_dacE6:	DACMetadata 11050,	PWM_01 ;$00000000, $00000800
ptr_dacE7:	DACMetadata 11050,	PWM_02 ;$00000000, $00000800
ptr_dacE8:	DACMetadata 11050,	PWM_03 ;$00000000, $00000800
ptr_dacE9:	DACMetadata 11050,	PWM_04 ;$00000000, $00000800
ptr_dacEA:	DACMetadata 11050,	PWM_04 ;$00000000, $00000659
ptr_dacEB:	DACMetadata 11050,	PWM_04 ;$00000000, $000004C2
ptr_dacEC:	DACMetadata 11050,	PWM_07 ;$00000000, $00000800
ptr_dacED:	DACMetadata 11050,	PWM_08 ;$00000000, $00000800
ptr_dacEE:	DACMetadata 11050,	PWM_09 ;$00000000, $00000800
ptr_dacEF:	DACMetadata 11050,	PWM_0A ;$00000000, $00000800
ptr_dacF0:	DACMetadata 11050,	PWM_0B ;$00000000, $00000800
ptr_dacF1:	DACMetadata 11050,	PWM_0C ;$00000000, $00000800
ptr_dacF2:	DACMetadata 11050,	PWM_0D ;$00000000, $00000800
ptr_dacF3:	DACMetadata 11050,	PWM_0E ;$00000000, $00000800
ptr_dacF4:	DACMetadata 11050,	PWM_0F ;$00000000, $00000800
ptr_dacF5:	DACMetadata 11050,	PWM_0F ;$00000000, $000005FE
ptr_dacF6:	DACMetadata 11050,	PWM_11 ;$00000000, $00000800
ptr_dacF7:	DACMetadata 11050,	PWM_11 ;$00000000, $000005FE
ptr_dacF8:	DACMetadata 11050,	PWM_13 ;$00000000, $00000800
ptr_dacF9:	DACMetadata 11050,	PWM_13 ;$00000000, $000005FE
ptr_dacFA:	DACMetadata 11050,	PWM_15 ;$00000000, $00000800
...
FPCSnare4FLStudio		IncludeDAC "Sonic-2-Clone-Driver-v2/DAC/FL-Studio/FPC Snare 4 FLStudio.raw"
The707CrashFLStudio		IncludeDAC "Sonic-2-Clone-Driver-v2/DAC/FL-Studio/707 Crash FLStudio.raw"
Firestarter		IncludeDAC "Sonic-2-Clone-Driver-v2/DAC/FL-Studio/Firestarter.raw"
...
SnareDrum		IncludeDAC "Sonic-2-Clone-Driver-v2/DAC/Sonic 1 & 2/SnareDrum.pcm"
...
PWM_00:		IncludeDAC	"Sonic-2-Clone-Driver-v2/PWM/ElectricKick.bin"
PWM_01:		IncludeDAC	"Sonic-2-Clone-Driver-v2/PWM/ElectricSnare.bin"
PWM_02:		IncludeDAC	"Sonic-2-Clone-Driver-v2/PWM/SplashCymbal.bin"
PWM_03:		IncludeDAC	"Sonic-2-Clone-Driver-v2/PWM/RideBell.bin"
PWM_04:		IncludeDAC	"Sonic-2-Clone-Driver-v2/PWM/Tom.bin"
PWM_07:		IncludeDAC	"Sonic-2-Clone-Driver-v2/PWM/ElectricHiHat.bin"
PWM_08:		IncludeDAC	"Sonic-2-Clone-Driver-v2/PWM/CrashCymbal.bin"
PWM_09:		IncludeDAC	"Sonic-2-Clone-Driver-v2/PWM/Clap.bin"
PWM_0A:		IncludeDAC	"Sonic-2-Clone-Driver-v2/PWM/AcousticKick.bin"
PWM_0B:		IncludeDAC	"Sonic-2-Clone-Driver-v2/PWM/AcousticSnare.bin"
PWM_0C:		IncludeDAC	"Sonic-2-Clone-Driver-v2/PWM/Bell.bin"
PWM_0D:		IncludeDAC	"Sonic-2-Clone-Driver-v2/PWM/FingersSnapping.bin"
PWM_0E:		IncludeDAC	"Sonic-2-Clone-Driver-v2/PWM/Cowbell.bin"
PWM_0F:		IncludeDAC	"Sonic-2-Clone-Driver-v2/PWM/Click.bin"
PWM_11:		IncludeDAC	"Sonic-2-Clone-Driver-v2/PWM/Bongo.bin"
PWM_13:		IncludeDAC	"Sonic-2-Clone-Driver-v2/PWM/Timpani.bin"
PWM_15:		IncludeDAC	"Sonic-2-Clone-Driver-v2/PWM/Silence.bin"
		even
